...
Telos将在其主网启动之前就及早解决许多司法挑战。 Telos仲裁组织（TAO）将立即准备就绪。 TAO将接受完整的Telos网络运营协议，不需要进一步批准。 对于它可以解决的案件，TAO也将有明确而有限的授权。 Telos基金会最初将资助TAO，以便在裁定涉及BP的案件时立即解决纠纷并保持没有（利益）冲突。 TAO的持续资金将来自仲裁费用。
