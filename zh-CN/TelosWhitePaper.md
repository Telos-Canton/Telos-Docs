...
答：Block.one在他们的众筹中出售了EOS通证。 他们接受了通证的销售款并作出了某些陈述。 他们无法轻易改变销售结果 - 特别是通过减少其最大贡献者的令牌，而这实际上是修复统的关键变革。 Telos是一个全新的系统，从来没有拿取任何人的金钱或向任何人作出承诺。 我们打算使用开源Eos软件建立一个网络（我们共同承担费用），以创建一个能更好地代表Eos真正目的的全新网络。
