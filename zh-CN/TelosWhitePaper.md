...
开发者可能更喜欢Telos系统，因为他们可以指定某些DApps为闭源，从而使他们的开发投入更加值得。 Telos网络将致力于降低部署成本保持RAM的可用性与网络需求相匹配，以减少早期参与者的RAM囤积情况。 这应该使部署DApps的成本低于Eos。 在所有其他方面，Telos网络将与Eos主网软件保持兼容，以便DApps可以在任一网络上互换运行。
