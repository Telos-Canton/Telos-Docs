...
由于来自希望收到通证的客户的压力，交易所可能会期待列上线TLOS，从而提供买卖方法。
...
Telos网络使用BP系统，该系统每天替换所有预备BP进行区块生产，以证明所有预备BP都能够在每次调用时生成区块。 该系统还允许任何不可运营的BP在错过30分钟（180个连续块）之后暂时换出，而不是在Eos主网上的3个小时。 这降低了由于6个BP在任何给定时间变为非活动状态而导致强制网络停顿的风险。
...
Eos通胀率定为每年5％。 Telos的目标是每年通胀2.5％。 TLOS通证通胀率将比EOS低50％。
