...
答：Telos启动组（TLG）的成员在创建和启动Telos网络方面发挥着核心作用。 他们承担着成本并为让网络充满生机而付出努力。 为了补偿他们的工作和承担的成本支出，他们将获得从Telos创始人储备池（TFRP）分发的在Telos区块链上的新创世通证作为补助。 这些通证在创世时都是零价值的，只有当TLG、Telos基金会和其他参与者能够启动一个有价值的网络时，才会获得价值。 这种方法跟加密货币发布时的赏金计划是一致的。 创始人和赏金得奖者的补偿总额占预期Telos通证发行量的1.8%，对于需要大量工作且没有寻求资金的加密货币项目来说这是一个很低的数字。
