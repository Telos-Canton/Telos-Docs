...
Telos有一个由多达30个预备节点组成的节点池，根据得票排名来择选和支付报酬。 备用节点的报酬是前21名区块生产节点的一半。 为了获得这些报酬，每个备用节点将定期每隔3-7天循环出块几个小时，以确保所有获得报酬的预备节点能够在需要时立即投入生产。 此循环计划意味着主要区块生产节点具有可预计的停机时间来维护其节点，从而降低了运作成本和提高可靠性。 未能生产区块的BP和预备BP将受到处罚。 该系统使得群组难以钻支付奖励系统的空子，并且灵活地阻止购买投票的行为。 Telos具有智能合约强制执行的最低要求（技术和信息），无论投票如何，每个BP必须满足这些要求。
