...
Telos网络定期在预备BP中循环生成区块（每个预备BP至少每3-7天一次）。 该循环系统还将临时替换任何在30分钟内未生产区块的现役BP。 该系统在网络弹性上具有三个明显的优势：非生产性BP将被更快地替换，这意味着在任何给定时间，6个BP停工导致网络暂停的可能性将会明显降低; 备用BP将定期证明其准备就绪; BP将获得半计划的停机时间来维护和更新他们的设备。 此外，Telos使用智能合约来强制执行BP的合格性，确保BP满足最低技术要求。
