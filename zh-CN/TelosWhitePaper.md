...
初期的Telos网络运作协议不会作没收任何通证的规定。 如果TLOS通证持有者选择修改宪法来加上这个条款，那将是他们的选择，而不是把规定强加于他们。 在创世时创建账号的Telos会员将被要求在在Telos主网激活后第一年至少访问一次他们的账户，来标明他们选择加入网络并且运行了协议。 在一年内不使用网络的创世帐户将被删除。
