...
Telos网络定期让预备节点循环生产区块（每个预备节点至少每3-7天一次）。 该循环系统还将临时替换任何在30分钟内未生产区块的现役区块生产节点。 该系统在网络弹性上具有三个明显的优势：非生产状态的BP将被更快地替换，这意味着在任何给定时间，6个BP停工导致网络暂停的可能性将会明显降低; 预备BP将定期证明其准备就绪; BP将获得半计划停机时间来维护和更新他们的设备。 此外，Telos使用智能合约和“神谕”来强制BP的合格性，确保BP满足最低技术要求。
