...
- 将产生新的通证以补偿创始人并为Telos Foundation Ltd提供资金 - Telos Foundation Ltd是一个资助对Telos网络重要工作的组织，然后通过工人提案才能获得资助。
...
Eos在主网发布时分配了64GB的RAM。 这个数字远远超过网络上任何DApp所需的数量。 对于投机者而言，这是一个巨大的土地抢占机会，可以以非常便宜的价格获得稀缺资源。 最终这个RAM将变得珍稀。 这种“RAM抓取”将导致高度投机和繁荣 - 萧条周期，这对网络稳定性起反作用，并使部署DApps成为预算难题。 对于认真的开发人员而言，这是针对Eos网络的罢工，可能会让小型创新者完全放弃Eos。
