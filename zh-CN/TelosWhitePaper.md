...
作为Eos主网启动组（EMLG）的投票和贡献成员，我们一直密切参与整个Eos主网启动过程。 这是去中心化决策的一个很棒的经验和实验，但它被由Eos中心化和Eos销售及流程要求引起的问题所破坏。 通过消除Eos固有的极端中心化，Telos将解决许多这些问题。 Telos有很多纬度去提升tokenomics，因为这与Block.one无关，且不会通过ICO或预售筹集资金。 因此，Telos网络可以用确认对网络最好的方式发行新的TLOS通证。
