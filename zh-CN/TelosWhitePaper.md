...
Eos宪法规定Eos网络上的所有DApp和合约都必须是开源的。 尽管这适用于许多合约，但它将限制了公链上的商业DApp开发。 开发者必须对他们创造的每个新产品进行大量投资，他们依靠保护他们的发明来回收这些投资。 如果一个公链上的商业DApp都必须是开源的，开发者将选择另一个能够保护他们作品的可代替公链。 此外，Eos主网正在经历对RAM预留的投机，这将推高在网络上部署DApps的成本。
