...
Telos将在其主网启动之前就及早解决许多司法挑战。 Telos仲裁组织（TAO）将立即准备就绪。 TAO将接受完整的Telos网络运作协议，不需要进一步核准。 TAO对于其可以解决的案件也将有明确而有限度的授权。 Telos基金会在早期会资助TAO，所以TAO在裁定涉及区块生产者的案件时能立即解决纠纷并确保没有（利益）冲突。 TAO的持续资金将来自仲裁费用。
