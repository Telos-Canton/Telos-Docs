...
- [The Telos Advantage](#the-telos-advantage)
  ...
  * [FOR BLOCK PRODUCERS](#for-block-producers)
    ...
    + [Equitable Voting / Inverse Vote Weighting](#equitable-voting--inverse-vote-weighting)
    + [Smart Contract Enforced Block Producer Requirements](#smart-contract-enforced-block-producer-requirements)
    + [Regular Downtime for Node Maintenance](#regular-downtime-for-node-maintenance)
- [Telos Token Distribution](#telos-token-distribution)
  * [Comparative Distribution](#comparative-distribution)
- [Eos Problems, Telos Solutions](#eos-problems-telos-solutions)
  * [Eos Problems and How Telos Will Solve Them](#eos-problems-and-how-telos-will-solve-them)
    + [Problem: User votes don’t matter – Whales run the network.](#problem-user-votes-don%E2%80%99t-matter-%E2%80%93-whales-run-the-network)
    + [Problem: DApp developers are disincentivized from using network.](#problem-dapp-developers-are-disincentivized-from-using-network)
    + [Problem: Network pause risk.](#problem-network-pause-risk)
    + [Problem: Standby BPs are not being properly paid and regularly tested.](#problem-standby-bps-are-not-being-properly-paid-and-regularly-tested)
    + [Problem: Eos RAM prospecting drives up the cost of deploying DApps.](#problem-eos-ram-prospecting-drives-up-the-cost-of-deploying-dapps)
    + [Problem: The Eos Constitution is unratified.](#problem-the-eos-constitution-is-unratified)
    + [Problem: Adjudication body not prepared at launch.](#problem-adjudication-body-not-prepared-at-launch)
    + [Problem: Eos has high inflation](#problem-eos-has-high-inflation)
    + [Problem: Eos accounts can be forfeit after 3 years](#problem-eos-accounts-can-be-forfeit-after-3-years)
- [The Telos Foundation](#the-telos-foundation)
- [Launching a Complete Network](#launching-a-complete-network)
  * [Voting Wallets](#voting-wallets)
  * [Governance](#governance)
  * [Referendum Process](#referendum-process)
  * [Worker Proposals Submission and Voting Process](#worker-proposals-submission-and-voting-process)
  * [Arbitration Process](#arbitration-process)
  * [Arbitration Body](#arbitration-body)
  * [Block Producer Enforcement](#block-producer-enforcement)
...
**Every elected block producer rotates out for 12 hours once per week.**<br/>
